...
static void activate (GtkApplication* app, gpointer user_data)
{
 ...
 GtkTreeIter iter3;  /* GrandChild of iter  */
 ...
 gtk_tree_store_set (store, &iter2,
                    1, "Volume 2: Seminumerical Algorithms",
                    -1);

 gtk_tree_store_append (store, &iter2, &iter1);
 gtk_tree_store_set (store, &iter2,
                    1, "Volume 3: Sorting and Searching",
                    -1);
///////////////////
 gtk_tree_store_move_after (store, &iter2, NULL);
 ...
 //gtk_tree_store_insert(store, &iter2, &iter1, 1);
 gtk_tree_store_insert(store, &iter1, NULL, 1);
 gtk_tree_store_set (store, &iter1,
                    1, "!!!!!!",
                    -1);
 gtk_tree_store_insert(store, &iter1, NULL, 1);
